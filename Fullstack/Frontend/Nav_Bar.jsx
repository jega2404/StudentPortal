...
export default function Navbar({back}) {
  console.log(back)
  return (
    <div className={`fixed top-0 w-full z-50 bg-${back} sm:bg-${back}`}>
    <Disclosure as="nav" >  
            ...
            <div className="relative flex h-16 items-center justify-between ">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center ">
                  ...
                  src={Logo}
                    alt="Your Company"
                  /><p className='text-white ml-2 text-3xl'>NIIT<span className='text-teal-700 text-3xl'></span></p>
                </div>
              ...
              {/* <button className="mr-4 px-4 py-2 bg-teal-700 text-white rounded-full focus:outline-none hover:bg-teal-500">
                Sign up
              </button>
...
<span class="absolute inset-0 border-2 border-teal rounded-full"></span>
</a> */}
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-teal-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
