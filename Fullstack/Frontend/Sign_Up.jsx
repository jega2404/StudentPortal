    ...
    return (
        <section>
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0"
                ...
                <div className="w-full bg-blue rounded-lg shadow dark:border-gray-900 md:mt-0 sm:max-w-md xl:p-0  dark:bg-transparent"
                    style={{
                    ...
                    <h1 className="text-xl font-bold leading-tight -tight text-teal-400 md:text-2xl dark:text-white-300 text-center">
    Create an <span className='text-red-400'>account..</span>
</h1>


                        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                            <div>
                                <label htmlFor="username" className="block mb-2 text-sm font-medium dark:text-teal-400">User Name</label>
                                <input
                                    type="text"
                                    name="name"
                                    id="name"
