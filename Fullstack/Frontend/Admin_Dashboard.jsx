...
import { Table, Thead, Tbody, Tr, Th, Td, Button, Heading, Avatar } from '@chakra-ui/react';
...
function Admin_DashBoard() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8989/getEnrollCount').then((response) => { console.log(response.data);setCount(response.data) })
  ...
  return (
    <div className='flex flex-row'>
      ...
      <div className='bg-gray-700 ml-40 h-full w-full'>
        <div className='bg-gray-700 text-3xl p-2 m-2 text-white rounded font-bold'>Welcome back <span className='text-teal-500'>,Admin</span></div>
