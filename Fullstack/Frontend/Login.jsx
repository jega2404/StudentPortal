...
import image from '../assets/images/j.gif';
...
function Login() {
  ...
  return (
    <>
      ...
      >
        <a href="#" className="flex fixed top-7 left-10 mb-6 text-2xl font-semibold text-gray-900 dark:text-black">
          <img className="w-8 h-8 mr-2" src={Logo} alt="logo" />
          NIIT <span className='text-teal-600'>Pvt Ltd</span>
        </a>

        <div className="sm:w-full max-w-md bg-blue rounded-lg shadow-md dark:border dark:bg-transparent dark:border-gray-700"
          style={{
        ...
        >
          <div className="p-6 space-y-4 md:space-y-6">
            <h1 className="text-xl font-bold leading-tight tracking-tight text-white-900 md:text-2xl text-white text-center">
              Register <span className='text-teal-900'> </span>
            </h1>
            <form className="space-y-4 md:space-y-6 px-4" action="#">
              <div>
                <label htmlFor="email" className="block mb-2 text-sm font-bold text-red-500 dark:text-white
">
                  Your email
                </label>
                <input
              ...
              <div>
                <label htmlFor="password" className="block mb-2 text-sm font-bold text-red-500 dark:text-white">
                  Password
                </label>
                <input
                  type="password"
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? <Spinner color='#7e22ce'/> : 'Signin'}
              </button>
              {errorMessage && (
